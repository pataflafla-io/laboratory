...
import { TaskApp, TaskStatus } from "@/applications/todoWithServerActions/taskApp";
    ...
    return (
        <>
            <h1 className="scroll-m-20 text-4xl font-extrabold tracking-tight text-balance">
                Todo Application with Server Actions
            </h1>
            <p className="leading-7 [&:not(:first-child)]:mt-6">
                ...
                to backend was by calling server actions (<i>i never thought JS would evolve to do things like the loved php</i> 😎)
